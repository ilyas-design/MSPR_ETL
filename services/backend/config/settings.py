...
DB_PATH = os.environ.get('DB_PATH', os.path.join(os.path.dirname(os.path.dirname(BASE_DIR)), 'mspr_etl.db'))
...
CORS_ALLOWED_ORIGINS = [
    ...
    "http://127.0.0.1:5173",
    "http://localhost",
    # Expo (mobile) — utile uniquement pour le mode web ; le natif n'a pas de CORS.
    "http://localhost:8081",
...
# Media (uploads : avatars + médias des publications du mini réseau social).
# MEDIA_ROOT pointe vers le volume partagé /data en conteneur ; en local il
# tombe dans services/backend/media. MinIO/S3 prendra le relais (sprint infra).
MEDIA_URL = '/media/'
