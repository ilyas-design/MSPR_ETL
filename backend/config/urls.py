...
urlpatterns = [
    ...
    path('api/me/engagement-stats/', EngagementStatsView.as_view(), name='me-engagement-stats'),
    path('api/me/weight-logs/', WeightLogView.as_view(), name='me-weight-logs'),
    path('api/me/plan-feedback/', PlanFeedbackView.as_view(), name='me-plan-feedback'),
